...
function scanRJ() {
    ...
    let anim = setInterval(() => {
        ...
        if (progresso >= 100) {
            ...
            fonte: G1 Globo 
            </a>. E <a href="https://cryptoid.com.br/criptografia-identificacao-digital-id-biometria/essse-sera-mesmo-o-maior-vazamentos-de-dados-pessoais-do-brasil/"
            style="color:#00ffcc; text-decoration: underline; text-decoration-color:#00ffcc; text-underline-offset:4px; font-weight:bold;"> Thiago Bordini</a>
            </p>
